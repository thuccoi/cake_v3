    ...
    <?php echo $this->Form->create('User'); ?>
        ...
        <table width="100%" class="tblForm">
            ...
            <tr>
                ...
                <td>
                    <p>
                    <?php if($this->data['User']['id'] == SYSTEM_ID): ?>
                        <?php echo $this->Html->link(__('ChangePassword'),array('action'=>'profile_password')); ?>
                    <?php else: ?>
                        <?php echo $this->Html->link(__('ResetPassword'),array('action'=>'reset_password',$this->data['User']['id'])); ?>
                    <?php endif; ?>
                    </p>
                </td>
            </tr>
